...
//
// All reads go through GET /dsh-my-workspace/state; opens through
// POST /dsh-my-workspace/open; the default-launcher preference persists
// host-side through POST /dsh-my-workspace/settings. Path copying never
// round-trips the host: navigator.clipboard runs right in the page.
