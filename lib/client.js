      ...
      useEffect(function () {
        ...
        Promise.all([getState(), getWorkspaces()])
          .then(function (results) {
            ...
            if (!resolved && typeof useSessions === 'function') {
              try {
                var byId = useSessions(function (s) { return s && s.byId ? s.byId : {} })
                resolved = resolveWorkspacePathFromSessions(openReq.label, byId)
